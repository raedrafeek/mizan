...
| e0f9db0 | **LENT & BORROWED accounts group**: person-debt pattern (lend = transfer to an "Other asset" account per person, borrow = "Loan" subtype); hints "lent · owed to you" / "borrowed · you owe this" / "settled"; SAVINGS detection takes precedence. Caveat documented in session: don't use Upcoming LOG IT for repayments (creates expense, not transfer) |
